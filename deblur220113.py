...
def batchTest(rootPath, postfixs):
    ...
    for i, file in enumerate(all_files):
        newname = file.replace("xiaoyezi_image_original", "xiaoyezi_image_denoise")
        print("-------------------------no.{}------------------------".format(i))
        print("file:", file)
#	print(newname)
...
if __name__ == '__main__':
    ...
    # batchTest(r"/media/lq4/mnccv/workHandover/5_updownJudgement/pruning/camera_photo/xiaomi_camera_1207_perspective", [".JPG", ".png", ".jpg"])  # 得到的是一个二值化的图像。在原图中进行变化。
    batchTest(r"/home/lq4/SSDProject/ImageGAN/image_superResolution/NAFNet/infer_data/xiaoyezi_image_original", [".JPG", ".png", ".jpg"])  # 得到的是一个二值化的图像。在原图中进行变化。
