...
def batchTest(rootPath, postfixs):
    ...
    for i, file in enumerate(all_files):
        newname = file.replace("down_final_data", "down_de_final_data")
        print("-------------------------no.{}------------------------".format(i))
        print(file)
...
if __name__ == '__main__':
    ...
    batchTest(r"/home/lq4/SSDProject/workHandover/5_updownJudgement/code/iphoneData/train/down_final_data", [".JPG", ".png", ".jpg"])  # 得到的是一个二值化的图像。在原图中进行变化。
